...
namespace Eld.Projectiles.BaseProjectiles
{
    public abstract class BaseIdleHoldoutProjectile : ModProjectile
    {
        ...
        // TODO -- There is no reason this load hook should need to be called from Eld.
        ...
        public static void LoadAll()
        {
            ...
            foreach (Type type in typeof(Eld).Assembly.GetTypes())
            {
